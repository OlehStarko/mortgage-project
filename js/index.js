  ...
  const banksItems = banks
    .map(({ name }) => {
      return `<li class="mortgage__banks-item" data-banks-item data-name='${name}'>
        ...
        <li class="mortgage__banks-item--button">
          <p class="button--edit" data-edit-bank>Edit</p>
          <p class="button--edit button--delete">Delete</p>
        </li>
      </li>`;
    })
    .join("");
